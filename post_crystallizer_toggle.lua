-- ReaScript: Toggle FX "CRYSTALLIZER" on track 'POST'
-- Author: Raven Trophy
-- Description: Toggles an FX called "CRYSTALLIZER" on a specific track

local TARGET_FX_NAME = "CRYSTALLIZER"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "CRYSTALLIZER"
