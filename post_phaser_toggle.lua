-- ReaScript: Toggle FX "PHASER" on track 'POST'
-- Author: Raven Trophy
-- Description: Toggles an FX called "PHASER" on a specific track

local TARGET_FX_NAME = "PHASER"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "PHASER"
