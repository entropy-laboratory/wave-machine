-- ReaScript: Toggle FX "OVD" on track 'PRE'
-- Author: Raven Trophy
-- Description: Toggles an FX called "OVD" on a specific track

local TARGET_FX_NAME = "OVD"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "OVD"
