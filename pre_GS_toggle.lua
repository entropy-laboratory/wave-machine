-- ReaScript: Toggle FX "GS" on track 'PRE'
-- Author: Raven Trophy
-- Description: Toggles an FX called "GS" on a specific track

local TARGET_FX_NAME = "GS"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "GS"
