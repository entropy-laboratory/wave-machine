-- ReaScript: Toggle FX "EQ3DB" on track 'POST'
-- Author: Raven Trophy
-- Description: Toggles an FX called "EQ3DB" on a specific track

local TARGET_FX_NAME = "EQ3DB"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "EQ3DB"
