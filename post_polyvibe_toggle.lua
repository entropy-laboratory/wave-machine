-- ReaScript: Toggle FX "POLYVIBE" on track 'POST'
-- Author: Raven Trophy
-- Description: Toggles an FX called "POLYVIBE" on a specific track

local TARGET_FX_NAME = "POLYVIBE"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "POLYVIBE"
