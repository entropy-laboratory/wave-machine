-- ReaScript: Toggle FX "DIST" on track 'PRE'
-- Author: Raven Trophy
-- Description: Toggles an FX called "DIST" on a specific track

local TARGET_FX_NAME = "DIST"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "DIST"
