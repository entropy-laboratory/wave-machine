-- ReaScript: Toggle FX "LFO" on track 'PRE'
-- Author: Raven Trophy
-- Description: Toggles an FX called "LFO" on a specific track

local TARGET_FX_NAME = "LFO"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "LFO"
