-- ReaScript: Toggle FX "FLANGER" on track 'POST'
-- Author: Raven Trophy
-- Description: Toggles an FX called "FLANGER" on a specific track

local TARGET_FX_NAME = "FLANGER"  -- <- dokładna nazwa FX (case sensitive!)
...
-- Przeglądamy wszystkie FX na torze i szukamy tego o nazwie "FLANGER"
